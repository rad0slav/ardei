	...
	<?php
		...
		if( $showbackgroundColor ){
			...
			if( has_post_thumbnail() && ! $useHeaderImg ){
				...
				echo '<header id="masthead" class="site-header parallax-window has-header-image" data-parallax="scroll" data-image-src="'. get_header_image() . '" role="banner">';
			}else{
				echo '<header id="masthead" class="site-header parallax-window default-header-image" data-parallax="scroll" data-image-src="'.get_template_directory_uri() . '/inc/images/default-header-img.jpg" role="banner">';
			}
		}
